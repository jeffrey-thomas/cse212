...
1. The results matched my predictions.

2. Algorithm3 has the best performance and Algorithm2 has the worst performance.

3. When n is small the difference won't be very noticeable to the user. When n=2 the difference between these Algorithms is a 1-2 iterations. When n=100, the diffrence is between less than 10 and thousands of iterations. 
